                        ...
                        <div className="main-entity">
                            <div className="side_bar">
                                <div className="inside">
                                    {/* Last updated: "2018-12-18 07:19:25 +0700"*/}
                                    <div className="logo">
                                        <a href="/companies/axon"><img alt="AXON Vietnam Big Logo" src="https://cdn.itviec.com/employers/axon/logo/w170/5A5yijCCzJ2QpgdQAnzegS6J/axon-logo.png" />
                                        </a>
                                    </div>
                                    ...
                                    <div className="employer-jobs-info">
                                        <div className="more_jobs">
                                            <div className="current-jobs links">
                                                <a rel="nofollow" href="/companies/axon#our-jobs">4 Jobs
                    </a>
                                            </div>
                            ...
                            <div className="job-detail">
                                <div className="header">
                                    <div className="job_info">
                                        <h1 className="job_title">
                                            Senior Front end Engineers (React)
                </h1>
                                        <div className="tag-list">
                                            <a className="big ilabel mkt-track" href="/it-jobs/html5"><span>
                                                HTML5
                    </span>
                                            </a><a className="big ilabel mkt-track" href="/it-jobs/javascript"><span>
                                                JavaScript
                    </span>
                                            </a><a className="big ilabel mkt-track" href="/it-jobs/reactjs"><span>
                                                ReactJS
                    </span>
                                            </a>
                                        </div>
                                ...
                                <div className="job_description">
                                    ...
                                    <div className="description">
                                        ...
                                        <div><b>Your Impact<br /><br /></b>
                                        </div>
                                        <div>As a senior software engineer on the Frontend Core team, you'll be responsible for building and maintaining the core frontend tools and framework used by every product team at Axon. Your day-to-day responsibilities will include defining reusable React components, defining our organization's standards and best practices, optimizing our build and test tools to maximize efficiency, and refactoring our products to improve overall quality and user experience. You will also have the opportunity to contribute to open source tools and libraries.</div>
                                        <div />
                                        <div>
                                            <br />The ideal candidate for this role is someone who is good at executing on large projects, and isn't afraid to make big changes to fundamental aspects of our code. You should have a good sense of design and a strong drive to do right by our customers. As a senior engineer, you'll be expected to participate in design reviews and provide guidance for more junior team members in the form of PR reviews and general mentorship. You'll have the opportunity to make changes that benefit our customers and all other frontend engineers, so it's important to be able to explain what changes you're making and why, to make it easier for the other teams to understand.</div>
                                        <p />
                                    </div>
                                </div>
                                <div className="skills_experience">
                                    ...
                                    <div className="experience">
                                        ...
                                        <ul>
                                            <li>5+ years of experience in frontend / full-stack software engineering</li>
                                            ...
                                            <li>Ability to explain core frontend principles and technologies to other engineers</li>
                                        ...
                                        <ul>
                                            ...
                                            <li>Jest + Enzyme</li>
                                            <li>PostCSS</li>
                                            <li>Interfacing with Scala and Go backend services</li>
                                        </ul>
                                        <p />
                                    </div>
                                </div>
                                <div className="love_working_here">
                                    ...
                                    <div className="culture_description">
                                        ...
                                        <p>Benefits</p>
                                        <ul>
                                            <li>An awesome office/working environment with the latest technologies</li>
                                            <li>Competitive salary and benefits including a great medical insurance plan for you and your family</li>
                                            <li>Free lunch, gym, phone stipend, parking</li>
                                            <li>Fun team activities and outings</li>
                                            <li>Flexible working hours</li>
                                            <li>Opportunities for training in the US</li>
                                            <li>Opportunities to ride along with real US police officers in real life situations, see them use our technology, and get inspired</li>
                                        </ul>We are an equal opportunity employer and value diversity at our company. We do not discriminate on the basis of race, religion, color, national origin, gender, sexual orientation, age, marital status, veteran status, or disability status.
                                <p />
                                    </div>
                                </div>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="carousel slide" id="jd-page-carousel" role="dialog" tabIndex={-1}>
                                ...
                                <div className="carousel__control-outer carousel__control-outer--left">
                                    <a rel="nofollow" className="carousel__control" data-slide="prev" href="#jd-page-carousel"><i className="fa fa-angle-left" />
                                    </a>
                                </div>
                                <div className="carousel__control-outer carousel__control-outer--right">
                                    <a rel="nofollow" className="carousel__control" data-slide="next" href="#jd-page-carousel"><i className="fa fa-angle-right" />
                                    </a>
                                </div>
                        ...
                        <div className="modal-body text-center">
                            ...
                            <div className="modal-body__message">
                                <div className="message">
                                    Don't miss your next <span className="keyword">ReactJS and JavaScript and HTML5</span> job in Ho Chi Minh City!
                        </div>
                                <div className="content">
                                    <div className="left-side">
                                        <p>
                                            Get new <span><span className="keyword">ReactJS and JavaScript and HTML5</span> jobs in Ho Chi Minh</span> instantly by email with <span className="job-robot">Job Robot</span>. Free.
                                </p>
